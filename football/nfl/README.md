...
## NEW SUPER COMMAND:
python3 odds_scraper.py && python3 game_scraper.py && python3 processing.py && cd .. && cd events && python3 upload_events.py && python3 update_completed_events.py && cd .. && cd training && python3 train_xgb.py